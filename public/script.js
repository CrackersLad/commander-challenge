import { db, auth, functions } from './firebase-setup.js?v=0.8';
import { fetchDeckPriceLocal } from './deck-parser.js?v=0.8';
import { getArchives } from './data-service.js?v=0.8';
import { initDeckActionsModule } from './deck-actions.js?v=0.8';
import { initRoomActionsModule } from './room-actions.js?v=0.8';
import { initPlayerViewModule } from './player-view.js?v=0.8';
import { initAdminModule } from './admin.js?v=0.8';
import { initCalendarModule } from './calendar.js?v=0.8';
import { initAuthModule } from './auth.js?v=0.8';
import { initHubModule } from './hub.js?v=0.8';
import { initProfileModule } from './profile.js?v=0.8';
...
import('./deck-builder-view.js?v=0.8').then(module => module.initDeckBuilderModule(utils, state));
