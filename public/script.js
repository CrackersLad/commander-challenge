import { db, auth, functions } from './firebase-setup.js?v=19.60';
import { fetchDeckPriceLocal } from './deck-parser.js?v=19.60';
import { getArchives } from './data-service.js?v=19.60';
import { initDeckActionsModule } from './deck-actions.js?v=19.60';
import { initRoomActionsModule } from './room-actions.js?v=19.60';
import { initPlayerViewModule } from './player-view.js?v=19.60';
import { initAdminModule } from './admin.js?v=19.60';
import { initCalendarModule } from './calendar.js?v=19.60';
import { initAuthModule } from './auth.js?v=19.60';
import { initHubModule } from './hub.js?v=19.60';
import { initProfileModule } from './profile.js?v=19.60';
