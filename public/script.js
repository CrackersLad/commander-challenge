import { db, auth, functions } from './firebase-setup.js?v=4.12';
import { fetchDeckPriceLocal } from './deck-parser.js?v=4.12';
import { getArchives } from './data-service.js?v=4.12';
import { initDeckActionsModule } from './deck-actions.js?v=4.12';
import { initRoomActionsModule } from './room-actions.js?v=4.12';
import { initPlayerViewModule } from './player-view.js?v=4.12';
import { initAdminModule } from './admin.js?v=4.12';
import { initCalendarModule } from './calendar.js?v=4.12';
import { initAuthModule } from './auth.js?v=4.12';
import { initHubModule } from './hub.js?v=4.12';
import { initProfileModule } from './profile.js?v=4.12';
import { initCardInspector, openCardInspector } from './card-inspector.js?v=4.12';
import { initWarRoom, openWarRoom } from './war-room.js?v=4.12';
import { initBoosterSimulatorModule, crackBoosterProduct, updateMarketAndCostDisplay, setSortMode, setFilterMode } from './booster-simulator.js?v=4.12';
import { initBoosterDraftModule } from './booster-draft.js?v=4.12';
import { buildGoogleCalendarUrl, downloadIcsFile, testDiscordWebhook } from './calendar-webhook-utils.js?v=4.12';
...
import('./deck-builder-view.js?v=4.12').then(module => module.initDeckBuilderModule(utils, state));
