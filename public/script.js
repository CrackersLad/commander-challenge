import { db, auth, functions } from './firebase-setup.js?v=0.20';
import { fetchDeckPriceLocal } from './deck-parser.js?v=0.20';
import { getArchives } from './data-service.js?v=0.20';
import { initDeckActionsModule } from './deck-actions.js?v=0.20';
import { initRoomActionsModule } from './room-actions.js?v=0.20';
import { initPlayerViewModule } from './player-view.js?v=0.20';
import { initAdminModule } from './admin.js?v=0.20';
import { initCalendarModule } from './calendar.js?v=0.20';
import { initAuthModule } from './auth.js?v=0.20';
import { initHubModule } from './hub.js?v=0.20';
import { initProfileModule } from './profile.js?v=0.20';
...
import('./deck-builder-view.js?v=0.20').then(module => module.initDeckBuilderModule(utils, state));
