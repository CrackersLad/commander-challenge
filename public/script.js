import { db, auth, functions } from './firebase-setup.js?v=7.5';
import { fetchDeckPriceLocal } from './deck-parser.js?v=7.5';
import { getArchives } from './data-service.js?v=7.5';
import { initDeckActionsModule } from './deck-actions.js?v=7.5';
import { initRoomActionsModule } from './room-actions.js?v=7.5';
import { initPlayerViewModule } from './player-view.js?v=7.5';
import { initAdminModule } from './admin.js?v=7.5';
import { initCalendarModule } from './calendar.js?v=7.5';
import { initAuthModule } from './auth.js?v=7.5';
import { initHubModule } from './hub.js?v=7.5';
import { initProfileModule } from './profile.js?v=7.5';
...
import('./deck-builder-view.js?v=7.5').then(module => module.initDeckBuilderModule(utils, state));
