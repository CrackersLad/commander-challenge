import { db, auth, functions } from './firebase-setup.js?v=0.40';
import { fetchDeckPriceLocal } from './deck-parser.js?v=0.40';
import { getArchives } from './data-service.js?v=0.40';
import { initDeckActionsModule } from './deck-actions.js?v=0.40';
import { initRoomActionsModule } from './room-actions.js?v=0.40';
import { initPlayerViewModule } from './player-view.js?v=0.40';
import { initAdminModule } from './admin.js?v=0.40';
import { initCalendarModule } from './calendar.js?v=0.40';
import { initAuthModule } from './auth.js?v=0.40';
import { initHubModule } from './hub.js?v=0.40';
import { initProfileModule } from './profile.js?v=0.40';
import { initCardInspector, openCardInspector } from './card-inspector.js?v=0.40';
import { initWarRoom, openWarRoom } from './war-room.js?v=0.40';
import { initBoosterSimulatorModule, crackBoosterProduct, updateMarketAndCostDisplay, setSortMode, setFilterMode } from './booster-simulator.js?v=0.40';
import { buildGoogleCalendarUrl, downloadIcsFile, testDiscordWebhook } from './calendar-webhook-utils.js?v=0.40';
...
import('./deck-builder-view.js?v=0.40').then(module => module.initDeckBuilderModule(utils, state));
