import { db, auth, functions } from './firebase-setup.js?v=0.26';
import { fetchDeckPriceLocal } from './deck-parser.js?v=0.26';
import { getArchives } from './data-service.js?v=0.26';
import { initDeckActionsModule } from './deck-actions.js?v=0.26';
import { initRoomActionsModule } from './room-actions.js?v=0.26';
import { initPlayerViewModule } from './player-view.js?v=0.26';
import { initAdminModule } from './admin.js?v=0.26';
import { initCalendarModule } from './calendar.js?v=0.26';
import { initAuthModule } from './auth.js?v=0.26';
import { initHubModule } from './hub.js?v=0.26';
import { initProfileModule } from './profile.js?v=0.26';
...
import('./deck-builder-view.js?v=0.26').then(module => module.initDeckBuilderModule(utils, state));
