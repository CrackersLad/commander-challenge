import { db, auth, functions } from './firebase-setup.js?v=0.27';
import { fetchDeckPriceLocal } from './deck-parser.js?v=0.27';
import { getArchives } from './data-service.js?v=0.27';
import { initDeckActionsModule } from './deck-actions.js?v=0.27';
import { initRoomActionsModule } from './room-actions.js?v=0.27';
import { initPlayerViewModule } from './player-view.js?v=0.27';
import { initAdminModule } from './admin.js?v=0.27';
import { initCalendarModule } from './calendar.js?v=0.27';
import { initAuthModule } from './auth.js?v=0.27';
import { initHubModule } from './hub.js?v=0.27';
import { initProfileModule } from './profile.js?v=0.27';
...
import('./deck-builder-view.js?v=0.27').then(module => module.initDeckBuilderModule(utils, state));
