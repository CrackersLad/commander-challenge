import { db, auth, functions } from './firebase-setup.js?v=0.45';
import { fetchDeckPriceLocal } from './deck-parser.js?v=0.45';
import { getArchives } from './data-service.js?v=0.45';
import { initDeckActionsModule } from './deck-actions.js?v=0.45';
import { initRoomActionsModule } from './room-actions.js?v=0.45';
import { initPlayerViewModule } from './player-view.js?v=0.45';
import { initAdminModule } from './admin.js?v=0.45';
import { initCalendarModule } from './calendar.js?v=0.45';
import { initAuthModule } from './auth.js?v=0.45';
import { initHubModule } from './hub.js?v=0.45';
import { initProfileModule } from './profile.js?v=0.45';
import { initCardInspector, openCardInspector } from './card-inspector.js?v=0.45';
import { initWarRoom, openWarRoom } from './war-room.js?v=0.45';
import { initBoosterSimulatorModule, crackBoosterProduct, updateMarketAndCostDisplay, setSortMode, setFilterMode } from './booster-simulator.js?v=0.45';
import { buildGoogleCalendarUrl, downloadIcsFile, testDiscordWebhook } from './calendar-webhook-utils.js?v=0.45';
...
import('./deck-builder-view.js?v=0.45').then(module => module.initDeckBuilderModule(utils, state));
